package com.domasalex.spring.cloud.billservice.service;

import com.domasalex.spring.cloud.billservice.entity.Bill;
import com.domasalex.spring.cloud.billservice.exception.BillNotFoundException;
import com.domasalex.spring.cloud.billservice.repository.BillRepository;
...
public class BillService {
    ...
    public Bill updateBill(Long billId, Long accountId, BigDecimal amount, Boolean isDefault, OffsetDateTime creationDate, Boolean overdraftEnabled){
        Bill bill = new Bill(accountId, amount, isDefault, OffsetDateTime.now(), overdraftEnabled);
